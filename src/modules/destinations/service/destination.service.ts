...
export class DestinationService {
  ...
  seed = async () => {
    const destinations: CreateDestinationInput[] = [
      ...
      { name: "Dharamshala", slug: "dharmshala", emoji: "🏔️", description: "Tibetan culture & mountain views", state: "Himachal Pradesh", country: "India", imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&auto=format&fit=crop" },
